...
bool LoadConfig(const std::string& path) {
    ...
    while (std::getline(file, line)) {
        ...
        else if (key == "cache_threshold_mb") g_config.cache_threshold_mb = std::stoi(value);
        ...
        else if (key == "idle_delay_minutes") g_config.idle_delay_minutes = std::stoi(value);
        else if (key == "charging_preferred") g_config.charging_preferred = (value == "true" || value == "1");
        else if (key == "minimum_battery_percent") g_config.minimum_battery_percent = std::stoi(value);
        ...
        else if (key == "max_cleanup_mb_per_run") g_config.max_cleanup_mb_per_run = std::stoi(value);
        else if (key == "max_files_per_batch") g_config.max_files_per_batch = std::stoi(value);
        else if (key == "max_batch_time_ms") g_config.max_batch_time_ms = std::stoi(value);
    }
    return true;
}
